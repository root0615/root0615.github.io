...
### 📌 왜 코사인 유사도를 쓰는가?<br>
다른 거리 측정법(유클리드 거리 등)은 벡터의 크기에 영향을 받습니다.<br>
코사인 유사도는 방향만 보기 때문에 텍스트 길이가 달라도 의미가 비슷하면 높은 값이 나옵니다.<br>
> "고양이"<br>
"고양이는 귀엽고 사랑스럽고 작은 동물이다."<br>
--> 유클리드 거리: 벡터 크기가 달라서 멀게 측정될 수 있음<br>
--> 코사인 유사도: 방향이 비슷하여 높게 측정<br>
